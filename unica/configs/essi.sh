...
# UN1CA configuration file for Exynos devices (r11s)
...
SOURCE_FINGERPRINT_CONFIG_SENSOR="egis_touch_display_optical"
...
SOURCE_WLAN_CONFIG_CUSTOM_BACKOFF="CAM_FRONT -1 -1 -1 -1 14 10"
